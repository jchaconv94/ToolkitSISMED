 ...
 *
 * Van en el mismo orden en que aparecen en la hoja: es el orden en que quien administra
 * las reconoce, y también el de la tabla que verá el establecimiento.
 *
...
export const STOCK_COLUMNS: StockColumn[] = [
  ...
  { key: "FECHA_DEL_EQUIPO", label: "Fecha del equipo", aliases: ["FECHA_DEL_EQUIPO", "FECHA DEL EQUIPO", "Fecha_Del_Equipo"], defaultState: false },
  { key: "ULTIMA_ACTUALIZACION", label: "Última actualización", aliases: ["ULTIMA_ACTUALIZACION", "ULTIMA ACTUALIZACION", "ULTIMA ACTUALIZACIÓN", "Ultima_Actualizacion"], defaultState: false },
];
