    ...
    try {
      ...
      const fetchPromises = urlsToUse.map(async (config, fallbackIndex) => {
        ...
        try {
          ...
          // 1. METADATA FIRST: dibuja las tarjetas rápido y luego actualiza solo datos necesarios.
          ...
          // Si metadata/selectivo no estuvo disponible, mantener compatibilidad con backends antiguos.
